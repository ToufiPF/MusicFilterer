...
import ch.epfl.musicfilterer.EmptyHiltTestActivity
import ch.epfl.musicfilterer.EmptyRegularTestActivity
import ch.epfl.musicfilterer.R
import ch.epfl.musicfilterer.testutil.SafeFragmentScenario.Companion.launchInHiltContainer
import ch.epfl.musicfilterer.testutil.SafeFragmentScenario.Companion.launchInRegularContainer
...
class SafeFragmentScenario<F : Fragment> @PublishedApi internal constructor(
    ...
    companion object {
        ...
        inline fun <reified T : Fragment> launchInRegularContainer(
            ...
            @StyleRes themeResId: Int = R.style.Theme_MusicFilterer,
